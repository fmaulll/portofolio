      ...
      <div className={`z-auto bg-purple opacity-100 ${dark ? "drop-shadow-sm" : "drop-shadow"} flex flex-col-reverse md:flex-row w-full md:w-4/6 h-full md:h-4/6`}>
        ...
        <div className={`${!dark && "bg-light"} w-full flex-1 px-8 py-6 justify-center flex flex-col`}>
          ...
          >
            ...
            <button
              className={`focus:outline-none ${isSent ? "disabled:bg-gray" : "hover:bg-[#fcc238] bg-yellow"} rounded-xl px-4 py-2 font-semibold mt-4 text-light drop-shadow transition-all`}
              type="submit"
              disabled={isDisable}
            >
              Submit
          ...
          {showToast && (
            <div className="w-full flex items-center justify-center mt-4">
              ...
              <div className="ml-3 text-sm font-normal text-gray">Message sent!</div>
            </div>
          )}
        </div>
      </div>
